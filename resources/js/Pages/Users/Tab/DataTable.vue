<template>
    <div>
        ...
        <div class="flex w-full mt-5 items-center  pb-4">
            <div class="w-1/2">
                <div class="ml-auto text-gray-500 text-xs sm:inline-flex hidden items-center">
                    <span class="mr-3">Page {{ users.current_page }} of 4</span>
            ...
            <!-- {{ users.links }} -->
            <div class="ml-auto text-gray-500 text-xs sm:inline-flex hidden items-center">
                <div class="ml-auto text-gray-500 text-xs" v-for="link in users.links">
                    <button class="inline-flex items-center h-8 px-4 justify-center text-gray-400 rounded-md shadow border border-gray-200 dark:border-gray-800 leading-none"
